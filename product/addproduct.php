...
$errors = [];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if ($productObj->doesProductExist($product["name"]))
...
<body>
    ...
    <form action="" method="post">
        ...
        <select name="category" id="category">
            ...
            <option value="Fiction" <?= (isset($product["category"]) && $product["category"] == "Fiction") ? "selected" : ""; ?>>Fiction</option>
            <option value="Science" <?= (isset($product["category"]) && $product["category"] == "Science") ? "selected" : "" ?>>Science</option>
            <option value="History" <?= (isset($product["category"]) && $product["category"] == "History") ? "selected" : ""; ?>>History</option>
        </select>
